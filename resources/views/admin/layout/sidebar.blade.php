<aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li><a href="{{ route('product.index') }}"><i class="fa fa-dollar"></i> <span>Product</span></a></li>
        <li><a href="{{ route('order.index') }}"><i class="fa fa-shopping-cart"></i> <span>Order</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>